...
django-mindoff is open sourced on [GitHub](https://github.com/mindoffwork/django-mindoff). The [documentation](https://django.mindoff.work/latest-release/) covers how to get started.
...
That methodology is the thing worth carrying forward. The specific tools will evolve. Pandas was the right choice at one point. Polars is the more defensible choice now. Something else will be a better choice in future. What doesn't change is the underlying thinking: data is a set of columns that transform in stages, and every part of your architecture should reflect that.

If you're starting a project with similar requirements, the [technical walkthrough of the merge-and-reduce approach](/notes/five-pandas-operations-that-replace-most-for-loops) is the most practically useful place to begin. What you build on top of it is up to you.
