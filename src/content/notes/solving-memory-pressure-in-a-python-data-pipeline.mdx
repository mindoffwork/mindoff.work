...
After two years of working through problems like these across multiple financial calculation engines, a pattern became visible: the infrastructure underneath all of it (the vectorized core, the batching, the queuing, the polling) was the same every time. That observation eventually became a python library.

Read: [How I Turned Data Pipeline Headaches Into a Python Library](/notes/how-i-turned-infrastructure-headaches-into-a-python-library) 