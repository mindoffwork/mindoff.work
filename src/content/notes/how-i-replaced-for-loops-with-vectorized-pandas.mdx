...
That became the internal standard for both engines. I wrote it up with worked examples in [a separate post](/notes/five-pandas-operations-that-replace-most-for-loops) for anyone bringing new engineers into this kind of work.
