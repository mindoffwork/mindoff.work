...
That became the internal standard for both engines. I wrote it up with worked examples in [a separate note](/notes/five-pandas-operations-that-replace-most-for-loops) for anyone bringing new engineers into this kind of work.

Speed without deployability is a different problem, and it arrived next. Concurrent clients, memory pressure, and the constraints of an 8GB server. 

Read: [Solving Memory Pressure in a Python Data Pipeline](/notes/solving-memory-pressure-in-a-python-data-pipeline)